...
data/prop.txt                  The annotated data, file format described below.
                               This includes the annotations for the entire Wall 
                               Street Journal Section of the Penn Treebank II.
                          
data/frames/                   Verb Lexicon / Lexical Guidelines. 
 
data/vloc.txt                  text file containing verb locations in the Penn 
                               Treebank that have been annotated
                          
data/verbs.txt                 verb list for Penn Treebank, Wall Street Journal section.

docs/notes.txt                 release notes for Propbank I

docs/readme.txt                this file

docs/file.tbl                  a complete listing of all files in this release

dtd/frameset.dtd               DTD for frames files
--------------------------------------------------------------------------------------
